...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'persons_person', (
            ...
            ('empresa', self.gf('django.db.models.fields.CharField')(max_length='200', db_index=True)),
        ))
        db.send_create_signal(u'persons', ['Person'])

        # Adding M2M table for field groups on 'Person'
        m2m_table_name = db.shorten_name(u'persons_person_groups')
        ...
        m2m_table_name = db.shorten_name(u'persons_person_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm[u'persons.person'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'persons_person_groups'))

        # Removing M2M table for field user_permissions on 'Person'
        db.delete_table(db.shorten_name(u'persons_person_user_permissions'))
