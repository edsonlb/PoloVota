...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PersonVote'
        db.create_table(u'persons_personvote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nota', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal(u'persons', ['PersonVote'])


    def backwards(self, orm):
        # Deleting model 'PersonVote'
        db.delete_table(u'persons_personvote')
