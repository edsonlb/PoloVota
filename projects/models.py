...
class Project(models.Model):
    ...
    liderNome = models.CharField(_('líder'), max_length=200, null=False)
    liderTelefone = models.CharField(_('telefone'), max_length=20, blank=True, null=False)
    liderEmail = models.EmailField(_('email'), max_length=100, null=False)
    ...
    ativo = models.CharField(_('ativo'), max_length=3, default='ATV')
